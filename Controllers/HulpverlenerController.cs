...
namespace wdpr_h.Controllers
{
    public class HulpverlenerController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Naam,Achternaam,Specialisme,Wachtwoord")] Hulpverlener hulpverlener)
        {
            if (ModelState.IsValid)
            {
                hulpverlener.Id = Guid.NewGuid();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Naam,Achternaam,Specialisme,Wachtwoord")] Hulpverlener hulpverlener)
        {
        ...
        private bool HulpverlenerExists(Guid id)
        {
